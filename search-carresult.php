...
$cnt=$query->rowCount();
?>
<p><span>Rezultat pretrage: <?php echo htmlentities($cnt);?> automobila</span></p>
</div>
</div>
...
{  ?>
      ...
      <aside class="col-md-3 col-md-pull-9">
              <a href="car-listing.php" class="btn">Nazad na ponudu auta</a>


        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Novo u ponudi</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price"><?php echo htmlentities($result->Price);?> KM</p>
                </div>
              </li>
              <?php }} ?>
