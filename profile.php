    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Osnovne informacije</h5>
          <?php  
         if($msg){?><div class="succWrap"><?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
            ...
            <div class="form-group">
              <label class="control-label">Adresa stanovanja:</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Spremi promjene <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
