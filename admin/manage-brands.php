			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Marke automobila</h2>
...
<a href="manage-brands.php?del=<?php echo $result->id;?>" onclick="return confirm('Želite li izbrisati ovaj brend?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
