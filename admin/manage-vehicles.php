			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Upravljanje automobilima</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Automobili</div>
...
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('Želite li izbrisati ovaj automobil?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
