...
$msg="Uspješna promijenjena slika.";
}
?>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Automobil slika 1</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Automobil slika 1 detalji</div>
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Učitaj novu sliku<span style="color:red">*</span></label>
												<div class="col-sm-8">
